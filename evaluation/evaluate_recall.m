...
p=importdata('../examples/car/car_test.txt');%cub ../../caffe/examples/model/cub/val.txt%cars  ../../caffe/examples/model/cars/car_test.txt
...
try
    features_all=[];
    for i=1:1
    fea1=sprintf('../examples/car/features/model_512_%d.fea',ind)
